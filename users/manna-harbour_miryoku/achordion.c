...
// ada (2026-09-11): upstream #pragma message ("use Chordal Hold instead") removed
// here — this Miryoku base predates Chordal Hold, which is the whole reason
// achordion is vendored. See the matching note in achordion.h.
...
__attribute__((weak)) bool achordion_streak_continue(uint16_t keycode) {
  ...
  if (get_mods() & (MOD_MASK_CG | MOD_BIT(KC_LALT) /* ada: MOD_BIT_LALT is post-2024 QMK; this base spells it MOD_BIT(KC_LALT) */)) return false;
