...
// ada (2026-09-11): upstream ships this file with a #warning saying it is
// deprecated in favour of the QMK-module version. That module needs QMK's
// community-module system, which this Miryoku base predates, so the legacy
// drop-in is the correct one here. The #warning is removed rather than kept:
// a warning that fires on every build trains the eye to skip the channel a
// real warning would use. Vendored from getreuer/qmk-keymap features/ (Apache-2.0).
